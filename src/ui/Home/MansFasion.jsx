...
const products = [
  {
    ...
    price: "$38.00",
    img: "/images/mans (6).webp",
  },
  {
    title: "Non-Stick Frying Pan",
    price: "$27.00",
    img: "/images/mans (5).webp",
  },
  {
    title: "Stainless Steel Knife Set",
    price: "$49.00",
    img: "/images/mans (4).webp",
  },
  {
    title: "4-Slice Bread Toaster",
    price: "$63.00",
    img: "/images/mans (3).webp",
  },
  {
    title: "Food Storage Containers Set",
    price: "$29.00",
    img: "/images/mans (2).webp",
  },
  {
    title: "Digital Kitchen Scale",
    price: "$21.00",
    img: "/images/mans (1).webp",
  },
];
    ...
    <div className="px-4 md:px-12">
      <div className="bg-white px-4 py-5 rounded shadow mb-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-bold uppercase">Men's Fashion</h2>
